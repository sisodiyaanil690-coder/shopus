                          ...
                          <div className="col-sm-6">
                            <div className="wrapper phone">
                              ...
                              <div className="wrapper-content">
                                ...
                                <p className="paragraph"><a href="tel:+916354218997">+916354218997</a></p>
                              </div>
                            </div>
                          </div>
                          <div className="col-sm-6">
                            <div className="wrapper phone">
                              ...
                              <div className="wrapper-content">
                                ...
                                <p className="paragraph">
                                  <a
                                    href="mailto:sisodiyaanil690@email.com"
                                    className="__cf_email__"
                                    data-cfemail="f8ad8b9d8ab89f95999194d69b9795"
                                  >
                                    sisodiyaanil690@email.com
                                  </a>
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="address">
                              <div className="contact-address">
                                ...
                                <div className="address-content">
                                  ...
                                  <p className="paragraph">
                                    405, InfoLabz, Vraj Avenue, above SAM'S
                                    Pizza, nr. Commerce Six Road, Swastik
                              ...
                              <div className="contact-map">
                                <iframe
                                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.6069876725674!2d72.55579940830641!3d23.038198179075845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e85ff3a38c353%3A0xdabe316634ef7e5e!2sInfoLabz!5e0!3m2!1sen!2sin!4v1775818463567!5m2!1sen!2sin"
                                  width="600"
                                  height="450"
                                  // style="border:0;"
                                  allowfullscreen=""
