...
function ProductWiseCate() {
  let [ProductApi, SetProduct] = useState([]);
  let [productCategory, SetCategory] = useState([]);
  let{CategoryWise} = useParams();

// product api call
  async function FetchProduct() {
    try {
      let respons = await axios.get(`https://dummyjson.com/products/category/${CategoryWise}`);
...
export default ProductWiseCate;
