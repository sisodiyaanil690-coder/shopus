              ...
              <div className="col-lg-3  col-sm-6">
                <div className="service-wrapper free-shipping">
                  ...
                  <div className="service-content">
                    <h5 className="service-info service-title">
                      Free Shipping
                    </h5>
            ...
            <div className="row gy-5">
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="about-us">
                  <h4 className="footer-heading footer-title">About</h4>
                  <div className="footer-link about-link">
                    <ul>
                      ...
                      <li>
                        <Link to="/Product-Sidebar">Shop</Link>
                      </li>
                      <li>
                  ...
                  <div className="footer-link contact-link">
                    <div className="address">
                      ...
                      <div className="details">
                        ...
                        <p><a href="https://maps.app.goo.gl/qCB2vieWst7SY3mH8" className="footer-heading">Infolabz Navrangpura Ahemdabad,384520</a></p>
                      </div>
                    </div>
                    <div className="phone address">
                      ...
                      <div className="details">
                        ...
                        <p> <a href="tel:6354218997">+916354218998</a></p>
                      </div>
                    </div>
                  </div>
                </div>
